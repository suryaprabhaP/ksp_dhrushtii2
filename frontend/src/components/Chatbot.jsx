        ...
        {activeMainView === VIEW_STATES.CHAT ? (
          <div id="view-chat" style={{ background: DRISHTI_THEME.colors.canvasBg }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <div style={{
                display: 'flex', alignItems: 'center', gap: '6px',
                background: activeDatasetName ? 'rgba(16, 185, 129, 0.12)' : DRISHTI_THEME.colors.cardBg,
                border: `1px solid ${activeDatasetName ? '#10b981' : DRISHTI_THEME.colors.borderSubtle}`,
                borderRadius: '8px', padding: '2px 8px', marginLeft: '6px'
              }}>
                <Database size={13} style={{ color: activeDatasetName ? '#059669' : DRISHTI_THEME.colors.forestDark }} />
                <span style={{ fontSize: '0.68rem', fontWeight: 800, color: activeDatasetName ? '#065f46' : DRISHTI_THEME.colors.forestDark }}>Dataset:</span>
                <span style={{ fontSize: '0.68rem', fontWeight: 700, color: activeDatasetName ? '#047857' : DRISHTI_THEME.colors.textSecondary }}>
